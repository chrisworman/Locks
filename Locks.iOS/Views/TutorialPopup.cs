...
namespace Locks.iOS.Views
{
	public class TutorialPopup : Sunfish.Views.Popup
	{
		...
		private void CreateAndAddFirstHint ()
		{
			...
			Sunfish.Views.Sprite nextButton = new Sunfish.Views.Sprite (LocksGame.ActiveScreen.LoadTexture ("CloseButton"), Sunfish.Constants.ViewLayer.Modal);
			//nextButton.EnableTapGesture(HandleNextButtonTapped);
			nextButton.EnableTapGesture(HandleCloseButtonTapped);
